...
public class AlloyKilnBlock extends AbstractAlloyKilnBlock
{
	@Nullable
	@Override
	...
	{
		return world.isClient ? null : checkType(type, MachineBlockRegistry.ALLOY_KILN_BLOCK_ENTITY, AbstractAlloyKilnBlockEntity::tick);
	}

	@Override
	public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit)
	{
		player.increaseStat(MachineStatisticRegistry.INTERACT_WITH_ALLOY_KILN, 1);
