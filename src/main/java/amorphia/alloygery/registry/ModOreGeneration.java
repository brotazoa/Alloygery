...
public class ModOreGeneration
{
	...
	public static void register()
	{
		...
		{
			RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> TIN_ORE_CONFIG = ConfiguredFeatures.register(
					Alloygery.MOD_ID + ":ore_tin",
					Feature.ORE,
					new OreFeatureConfig(TIN_ORES, (int) AlloygeryConfig.tinOre.size.getValue())
			);

			RegistryEntry<PlacedFeature> TIN_ORE_PLACEMENT = PlacedFeatures.register(
					Alloygery.MOD_ID + ":ore_tin",
					TIN_ORE_CONFIG,
					List.of(
			...
			BiomeModifications.addFeature(
					...
					TIN_ORE_PLACEMENT.getKey().get()
			);
		}

		if (AlloygeryConfig.nickelOre.shouldGenerate.getValue())
		{
			RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NICKEL_ORE_CONFIG = ConfiguredFeatures.register(
					Alloygery.MOD_ID + ":ore_nickel",
					Feature.ORE,
			...
			RegistryEntry<PlacedFeature> NICKLE_ORE_PLACEMENT = PlacedFeatures.register(
					Alloygery.MOD_ID + ":ore_nickel",
					NICKEL_ORE_CONFIG,
					List.of(
			...
			BiomeModifications.addFeature(
					...
					GenerationStep.Feature.UNDERGROUND_ORES,
					NICKLE_ORE_PLACEMENT.getKey().get()
			);
		}
		...
		if (AlloygeryConfig.titaniumOre.shouldGenerate.getValue())
		{
			...
			RegistryEntry<PlacedFeature> TITANIUM_ORE_PLACEMENT = PlacedFeatures.register(
					Alloygery.MOD_ID + ":ore_titanium",
					TITANIUM_ORE_CONFIG,
					List.of(
			...
			BiomeModifications.addFeature(
					...
					GenerationStep.Feature.UNDERGROUND_ORES,
					TITANIUM_ORE_PLACEMENT.getKey().get()
			);
		}
	}
	...
	static
	{
		TIN_ORES = List.of(OreFeatureConfig.createTarget(OreConfiguredFeatures.STONE_ORE_REPLACEABLES, ModBlocks.TIN_ORE.getDefaultState()), OreFeatureConfig.createTarget(OreConfiguredFeatures.DEEPSLATE_ORE_REPLACEABLES, ModBlocks.DEEPSLATE_TIN_ORE.getDefaultState()));
	}
}
