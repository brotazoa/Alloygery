...
public class BlastAlloyKilnBlock extends AbstractAlloyKilnBlock
{
	...
	{
		return world.isClient ? null : checkType(type, ModBlocks.BLAST_ALLOY_KILN_BLOCK_ENTITY, AbstractAlloyKilnBlockEntity::tick);
	}

	@Override
	public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit)
	{
		player.increaseStat(ModStatistics.INTERACT_WITH_BLAST_ALLOY_KILN, 1);
