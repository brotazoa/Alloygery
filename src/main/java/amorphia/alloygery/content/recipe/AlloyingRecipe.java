...
{
	public AlloyingRecipe(Identifier id, String group, List<Ingredient> inputs, ItemStack output, int smeltingTime, float experience)
	{
	...
	public static class Type implements RecipeType<AlloyingRecipe>
	{
		...
		public static final Identifier ID = Alloygery.identifier("alloying");
	...
	public static class Serializer extends AbstractAlloyingRecipe.Serializer
	{
		...
		public AbstractAlloyingRecipe read(Identifier id, JsonObject json)
		{
			...
			return new AlloyingRecipe(id, group, inputs, output, smeltingTime, experience);
		}
