...
public class AlloygeryToolMaterialDataV1 implements IAlloygeryToolMaterialData
{
	...
	{
		return this.replace ? AlloygeryToolMaterial.AlloygeryToolMaterialMerger.override(material, dataHolder) : AlloygeryToolMaterial.AlloygeryToolMaterialMerger.merge(material, dataHolder);
	}

	public static class Serializer implements JsonDeserializer<AlloygeryToolMaterialDataV1>
	{
		@Override
		public AlloygeryToolMaterialDataV1 deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext)
				throws JsonParseException
		{
			...
			AlloygeryToolMaterialDataV1 dataV1 = new AlloygeryToolMaterialDataV1();
		...
		private void deserializeToolPartSetting(JsonElement jsonElement, AlloygeryToolMaterial.AlloygeryToolMaterialBuilder builder, ToolPartType partType, JsonDeserializationContext context)
		{
			JsonObject json = jsonElement.getAsJsonObject();
