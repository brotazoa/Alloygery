...
public class DynamicPickaxeItem extends PickaxeItem implements IDynamicTool
{
	...
	public DynamicPickaxeItem(Settings settings)
	{
	...
	public ItemStack getDefaultStack()
	{
		...
		ToolNBTHelper.addAlloygeryNBTToToolStack(tool, ToolNBTHelper.createToolNBTFromMaterials(ToolMaterials.IRON, ToolMaterials.VANILLA_STICK, ToolType.PICKAXE));
		return tool;
	}
